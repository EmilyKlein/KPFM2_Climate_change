import.all.parameters <- function(file.string="C:/Users/emily/Desktop/SWFSC/Proposals, paperwork, etc/Klein_et_al_ClimateChg_PLOS/GGP input and code/KPFM2 Input/nst_new.txt", foraging.prefix="p")
 {
